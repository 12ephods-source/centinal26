...
The current repository also includes the fail-closed evidence path under
`automation/deployment/enrollment_package/`, which captures a SHA-256 bundle on
the physical device and verifies its integrity/origin separately on the controller.
