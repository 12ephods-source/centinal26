...
4. PR #240 — exact head `724aadc636fdd368369b7103ad91a0cc341df1b0` is green across six workflows for the bounded 2–4-mode stress test, but the PR is still draft/unmerged and therefore is not canonical mainline state.
...
- Should PR #240 be merged after review, and what finite-size scaling is required before any field-mode-limit hypothesis is admissible?
