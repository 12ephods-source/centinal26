...
with tempfile.TemporaryDirectory() as td:
    ...
    first = kernel.commit("r1", ALL, "initial", "test", {"fixture": "all-pass"})
    ...
    demoted = kernel.commit("r1", broken, "fault:restart", "test")
    ...
    recovered = kernel.commit("r1", ALL, "recovered:restart", "test")
