...
def test_v31_installer_pins_framework_bytes_and_immutable_ref():
    text = (
    ...
    assert "5506e29b62c678da9df33e3b8eb958ebe93dc153" in text
    assert "agent/automation-os-universal-installer-v3" not in text
