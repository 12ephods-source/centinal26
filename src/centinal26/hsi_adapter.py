...
def to_frost_call_envelope(request: HSIRequest) -> Json:
    ...
    exist in the normal Centinal26 capability registry and pass authorization,
    execution, verification, evidence, and terminal-state gates.
    """
    return {
...
def ingest_hsi_request(store: Any, raw: Any, *, catalog: Any = None) -> Any:
    """Enter HSI work through Centinal26's existing proposal-only canonical gateway."""
