...
def scalar_only_discrete_anomaly_status(*, chiral_fermions_charged: bool) -> str:
    ...
    Scalars do not contribute to the usual chiral triangle anomaly sums.  This
    does not establish a complete discrete-gauge UV completion; it only closes
    the chiral-matter anomaly sub-gate when all chiral fermions are neutral.
    """
