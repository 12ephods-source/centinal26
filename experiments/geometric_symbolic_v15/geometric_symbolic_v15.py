"""v15 boundary singleton-anchor dose test.
...
between the v14 7.5% PASS and v13 5% FAIL without changing scientific thresholds.
"""
...
v11.ANCHOR_RATE = 0.0625
v11.SEEDS = (130, 131, 132)
